...
###[View Live Doi.ai &rarr;](https://huangxuan.me)
...
```
# Site settings
title: Doi.ai             # title of your website
SEOTitle: Doi.ai			# check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Doi.ai”** but I want the title shows in search engine is **“黄玄的博客 | Doi.ai”** which is multi-language.
...
Doi.ai is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
